const Button = ({
	...
	const variantClasses = {
		...
		outline:
			'border-2 border-[#34a4b0] text-[#34a4b0] hover:bg-[#34a4b0]/10 focus:ring-0', // <--- focus:ring-0 qo‘shildi
		ghost: 'text-[#34a4b0] hover:bg-[#34a4b0]/10 focus:ring-0', // agar ghost variant ham border bilan ikki qatlam bo‘lishni xohlmasa
	}
